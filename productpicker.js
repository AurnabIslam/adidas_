            ...
            <div class="columns is-mobile">
                <div class="column">
                    <div class="box">
                        ...
                        <button onclick="cartadd()">Buy</button>
                    </div>
                </div>
                <div class="column">
                    <div class="box">
...
var cart_count = 0;
var price_of_shoe = 5.50;
var cartno = document.getElementById('cartcount');
...
function cartadd() {
    ...
    if (cart_count >= 1) {
        cartno.innerHTML = `(${cart_count})`;
        cartno.style.display = 'initial';
        document.getElementById('modal_card_body').innerHTML =
            `
        <div class="columns">
            <div class="cloumn">
                <p>Shoe(s) in your cart: <br></p>
                <p>Price per shoe: <br></p>
                <p>Total:</p>
            </div>
            <div class="cloumn" style="margin-left:10px; text-align:center;">
                <p>${cart_count} <br></p>
                <p>$ ${price_of_shoe} <br></p>
                <p>$ ${cart_count*price_of_shoe}</p>
            </div>
        </div>
        `;
    } else {
...
document.getElementById('cart_btn').addEventListener('click', function () {
    document.getElementById('cart_modal').classList.add("is-active");
})

document.getElementById('modal_close').addEventListener('click', function () {
    document.getElementById('cart_modal').classList.remove("is-active");
})

document.getElementById('modal_close_2').addEventListener('click', function () {
    document.getElementById('cart_modal').classList.remove("is-active");
})

function clear_cart(){
    cartno.style.display = 'none';
    document.getElementById('modal_card_body').innerHTML = `Your Cart is empty!`;
}
